...
public class SeaFoodComponents {
        ...
        public static final FoodComponent RICE = (new FoodComponent.Builder()).hunger(2)
                .saturationModifier(0.25F).build();

        public static final FoodComponent RICE_BALL = (new FoodComponent.Builder()).hunger(3)
